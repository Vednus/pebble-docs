...
You can create a Comp Set or competiton round in both the website and the app. To create a comp round on the website, look here: [Creating a Comp Set](/competitions/create-comp-set). Not all of the options that are available on the website are available in the app.
...
On the form that appears, enter in the name and settings for the new round. Refer to the section on [creating a comp set on the website](/competitions/create-comp-set) for a description of the settings.
