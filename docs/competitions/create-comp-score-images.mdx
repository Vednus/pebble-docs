## Creating a Scoring Image
For a Comp Set that scores its climbs by holds, it is helpful to create comp scoring images associated with each climb. Comp scoring images are images of climbs in the comp that have each scored hold marked with a number. These can be created in the Pebble Mobile App.
