...
- **Modified Redpoint**: Competitions with zone(s) and tops like a World Cup round, but competitors are allowed to try the climbs whenever they want within an allotted time.
- **NEW!! Scanner Challenges**: Use Pebble Connect scanners to log activities such as classes or fitness challenges and determine winners based on the number of activities logged.
