...
import GymSchedule from "../images/gym-setting-schedule.png"
...
![week to reset](../images/schedule-choose-week.jpg)

### Choose an area to reset or task to complete

Choose the gym (if more than one), area or task, and number of setters for the next reset and hit save.

![assign setters](../images/schedule-form.png)

### Drag and drop setters that will complete the reset or the task from the list of available setters above.

![drag and drop](../images/schedule-drag.png)
...
### Gym users can view the schedule

Gym users can see the schedule so that they will know when the next reset is happening.

<ImageSizer src={GymSchedule} alt="Gym Schedule" width={300} />
