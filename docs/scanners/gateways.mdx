...
3. Open a web browser and go to http://10.130.1.1/. For a user name and password, use "root" and the password you were sent to connect.
  * If you need to connect directly with a cat-5 cable, follow the instructions [here](http://wiki.dragino.com/xwiki/bin/view/Main/User%20Manual%20for%20All%20Gateway%20models/LPS8N%20-%20LoRaWAN%20Gateway%20User%20Manual/) in section 11.3. Use the IP address: http://172.31.255.254:8000/ to connect after setting up the ethernet and disabling any firewalls on your computer.
