...
### GraphQL Playground
You can use the graphql playground to inspect the schema and view the query parameters by going here:
https://www.pebbleclimbing.com/.netlify/functions/graphql

![Playground](../images/graphql-playground.png)

Currently the playground has all queries available on Pebble, but your api key only supports the following:
