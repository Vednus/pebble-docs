...
2. You will now see the area form. You can edit any area by clicking on the pencil icon next to the area name on the area page and it will bring you back to this form. Most of the fields are self-explanatory, but I will explain a few of them below.
